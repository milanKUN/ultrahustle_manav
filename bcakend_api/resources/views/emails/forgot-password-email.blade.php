                ...
                <table role="presentation" width="100%">
                  <tr>
                    <td style="padding: 34px 10px 0 10px">
                      ...
                      <p class="subtext">You are receiving this email because we received a password reset request for your account.</p>
                      <div class="button-wrap">
                        <a href={{$resetUrl}} class="button"
                          >Reset Password</a
                        >
                      </div>
                      <p class="subtext">This password reset link will expire in 60 minutes.</p>
                      <h4 class="subtext">If you did not request a password reset, no further action is required.</h4>
                    </td>
                  </tr>
                </table>
